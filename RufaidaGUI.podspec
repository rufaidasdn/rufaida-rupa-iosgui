#
#  Be sure to run `pod spec lint RufaidaGUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  Rufaid Patient Affairs is one of the apps to support KSMC Patient.
  To create, update and follow up the Appointment and Medication. this
  GUI will support the application for developing and implmenting
  custom UI.
                   DESC
